...
function ShowHideColumn1({ columns = [], setColumns }) {
  ...
  return (
    <React.Fragment>
      <Button onClick={handleClick} className="btn-sm" style={{ width: "80px", height: "40px", fontSize: "13px" }}>Ẩn/Hiện</Button>
...
ShowHideColumn1.propTypes = {
  columns: propTypes.array,
  setColumns: propTypes.func,
};

export default React.memo(ShowHideColumn1);
