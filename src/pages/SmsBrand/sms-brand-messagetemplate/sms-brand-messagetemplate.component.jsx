...
import AddMessageTemplateBrandComponent from './components/add-brand-messagetemplate.component';
import ShowHideColumnComponent from '../../../Components/Common/show-hide-column.component';

const SmsMessageTemplateBrandList = () => {
  ...
  const handleDelete = async () => {
    try {
      setLoading(true);
      await SmsBrandAPI.deleteSmsBrandMessageTemplate(recordId.current);
      addToast({ message: Message.DELETE_SUCCESS, type: 'success' });
      await getListSmsMessageTemplateBrand();
  ...
  const getListSmsMessageTemplateBrand = useCallback(async () => {
    try {
      setLoading(true);
      const response = await SmsBrandAPI.getSmsBrandMessageTemplateList();
  ...
  useEffect(() => {
    getListSmsMessageTemplateBrand();
  }, [getListSmsMessageTemplateBrand]);
  ...
  document.title = 'Quản lý danh sách SMS Brand';
  ...
  return (
    <React.Fragment>
      ...
      <div className='page-content'>
        <Container fluid>
          <BreadCrumb
            ...
            pageTitle='Quản lý danh sách SMS Brand'
          />
          <Row>
            <Col lg={12}>
              <Card>
      ...
      <AddMessageTemplateBrandComponent
        isOpen={openModal.isOpen}
        close={close}
        getList={getListSmsMessageTemplateBrand}
...
export default SmsMessageTemplateBrandList;
