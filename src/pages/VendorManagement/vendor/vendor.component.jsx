...
import ViewRecordComponent from '../../../Components/Common/view-record.component';
import { Message } from '../../../shared/const/message.const';
import AddVendorComponent from './components/add-vendor.component';
import { VIEW_CONFIG } from './const/column.config';
...
const VendorList = () => {
  ...
  const handleDelete = async () => {
    try {
      setLoading(true);
      await VendorAPI.deleteVendor(recordId.current);
  ...
  const getListVendor = useCallback(async () => {
    try {
      setLoading(true);
  ...
  return (
    <React.Fragment>
      ...
      <div className='page-content'>
        <Container fluid>
          <BreadCrumb title='Nhà cung cấp' pageTitle='Quản lý số' />
          <Row>
            <Col lg={12}>
              <Card>
                <CardHeader>
