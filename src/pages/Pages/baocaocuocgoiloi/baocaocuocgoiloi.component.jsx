...
const BaoCaoCuocGoiLoi = () => {
  ...
  const getListBaoCao = useCallback(async () => {
    try {
      ...
      setData(response.dataerr);
      setSearchData(response.dataerr);
      setLoading(false);
    } catch (error) {
      setLoading(false);
    }
  ...
  return (
    <React.Fragment>
      ...
      <div className='page-content'>
        <Container fluid>
          <BreadCrumb title='Report Call Fail' pageTitle='Alerts' />
          <Row>
            <Col lg={12}>
              <Card>
                <CardHeader>
                  <h4 className='card-title mb-0 flex-grow-1'>
                  Báo cáo tổng hợp cuộc gọi khách hàng thực hiện trong 15 phút gần đây có duration = 0
                  </h4>
                </CardHeader>
...
export default BaoCaoCuocGoiLoi;
