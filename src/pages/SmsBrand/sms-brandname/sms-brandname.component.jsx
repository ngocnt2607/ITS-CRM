...
import AddSmsBrandComponent from './components/add-smsbrand.component';
...
const SmsBrandList = () => {
  ...
  const getListSmsBrand = useCallback(async () => {
    try {
      setLoading(true);
  ...
  return (
    <React.Fragment>
      ...
      <AddSmsBrandComponent
        isOpen={openModal.isOpen}
        close={close}
        getList={getListSmsBrand}
        getList1={getListSmsBrand}
