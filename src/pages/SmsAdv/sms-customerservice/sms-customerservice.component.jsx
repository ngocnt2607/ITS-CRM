...
import AddCustomerServiceAdvComponent from './components/add-customerservice.component';
import ShowHideColumnComponent from '../../../Components/Common/show-hide-column.component';

const SmsCustomerServiceAdvList = () => {
  ...
  const handleDelete = async () => {
    try {
      ...
      await getListSmsCustomerServiceAdv();
  ...
  const getListSmsCustomerServiceAdv = useCallback(async () => {
    try {
      setLoading(true);
      const response = await Promise.all([
        SmsAdvAPI.getSmsCustomerServiceList()
      ]);
  ...
  return (
    <React.Fragment>
      ...
      <AddCustomerServiceAdvComponent
        isOpen={openModal.isOpen}
        close={close}
        getList={getListSmsCustomerServiceAdv}
...
export default SmsCustomerServiceAdvList;
