            ...
            <Dropdown isOpen={isCartDropdown} toggle={toggleCartDropdown} className="topbar-head-dropdown ms-1 header-item">
                ...
                <DropdownMenu className="dropdown-menu-xl dropdown-menu-end p-0"
                        ...
                        <div className="p-2">
                            ...
                            {cartData.map((item, key) => (<div className="d-block dropdown-item text-wrap dropdown-item-cart px-3 py-2" key={key}>
                                <div className="d-flex align-items-center">
                                    <img src={item.img}
                                        className="me-3 rounded-circle avatar-sm p-2 bg-light shadow" alt="user-pic" />
                                    ...
                                    <div className="ps-2">
                                        <button type="button" className="btn btn-icon btn-sm btn-ghost-secondary remove-item-btn shadow-none" onClick={(e) => { removeItem(e.target); }}><i
                    ...
                    <div className="p-3 border-bottom-0 border-start-0 border-end-0 border-dashed border d-grid">
                        ...
                        <Link to="/apps-ecommerce-checkout" className="btn btn-success text-center">Checkout</Link>
                    </div>
                </DropdownMenu>
            </Dropdown>
        </React.Fragment>
